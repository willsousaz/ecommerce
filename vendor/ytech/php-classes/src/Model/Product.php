<?php 
	...
	public function save()
	{
		...
		$results[0] = $sql->select("CALL sp_products_save(:idproduct,:desproduct,:vlprice,:vlwidth,:vlheight,:vllength,:vlweight,:desurl)", array(
	...
	public function checkPhoto(){
		...
		if(file_exists(
			...
			$url = "/res/img/product/".$this->getidproduct().".jpg";
		
		}else{

			$url = "/res/img/product/product.jpg";
